...
class Grafo:
    ...
    def graficar(self):
        with open("Modificado1.plot","w") as archivo:
             ...
             print("set output 'ModificadoGraf1.png'", file=archivo)
             ...
             for a in self.aristas:  
                 (x1,y1,x2,y2)=a
                 print("set arrow {:d} from {:f}, {:f} to {:f}, {:f} head lw 3".format(num,x1,y1,x2,y2),file=archivo)
                 num+=1
             print("show arrow", file=archivo)
             print("plot 'ModificadoNodos.dat' using 1:2 with points pt 6", file=archivo)
