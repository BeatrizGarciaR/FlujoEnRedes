...
for (u in 1:4){
  ...
  boxplot(umbral, xaxt="n",ylim=c(0,100), xlab=c("Repeticiones"), ylab=c("Flujo máximo"))
...
for (u in 1:4){
  ...
  boxplot(umbral, xaxt="n",ylim=c(0,85), xlab=c("Quitando nodos"), ylab=c("Flujo máximo"))
...
boxplot(t(TiempoEjecucionA), xaxt="n",ylim=c(0,30), xlab=c("Variación en el umbral"), ylab=c("Tiempo de ejecución en segundos"))
axis(1, at=1:10, labels=seq(1,10,1))
...
boxplot(t(TiempoEjecucionN), xaxt="n",ylim=c(0,50), xlab=c("Variación en el umbral"), ylab=c("Tiempo de ejecución en segundos"))
axis(1, at=1:10, labels=seq(1,10,1))
